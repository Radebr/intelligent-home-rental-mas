...
public class CustomerLoginDialog extends JDialog {
    ...
    private static final Logger log = LoggerFactory.getLogger(CustomerLoginDialog.class);
    ...
    public CustomerLoginDialog(Frame owner, DatabaseHelper dbHelper) {
        super(owner, "Customer Secure Login", true);
        this.dbHelper = dbHelper;
        
        if (this.dbHelper == null) {
             log.error("FATAL: DatabaseHelper is NULL in LoginDialog!");
